...
class _EnrichmentWorkerFutureCallDispatcher {
  _EnrichmentWorkerFutureCallDispatcher(this._invokeFutureCall);

  final _InvokeFutureCall _invokeFutureCall;

  Future<void> invoke(_i1.SerializableModel? object) {
    return _invokeFutureCall(
      'EnrichmentWorkerInvokeFutureCall',
      object,
    );
  }
}

class _ImageHealthCheckFutureCallDispatcher {
  _ImageHealthCheckFutureCallDispatcher(this._invokeFutureCall);

  final _InvokeFutureCall _invokeFutureCall;

  Future<void> invoke(_i1.SerializableModel? object) {
    return _invokeFutureCall(
      'ImageHealthCheckInvokeFutureCall',
      object,
    );
  }
}
...
class ImageHealthCheckInvokeFutureCall
    extends _i1.FutureCall<_i1.SerializableModel> {
  @override
  _i2.Future<void> invoke(
    _i1.Session session,
