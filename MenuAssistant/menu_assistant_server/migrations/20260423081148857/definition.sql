...
--
-- Class AppUserProfile as table app_user_profile
--
...
--
-- Class CuratedDish as table curated_dish
--
...
--
-- Class CuratedDishImage as table curated_dish_image
--
...
--
-- Class DatasetVersion as table dataset_version
--
...
--
-- Class DishCatalog as table dish_catalog
--
...
--
-- Class DishImage as table dish_image
--
...
CREATE INDEX "dish_image_health_idx" ON "dish_image" USING btree ("lastCheckedAt");

--
-- Class DishProviderStatus as table dish_provider_status
--
...
--
-- Class DishTranslation as table dish_translation
--
...
--
-- Class FavoriteMenuItem as table favorite_menu_item
--
...
-- Indexes
CREATE UNIQUE INDEX "favorite_menu_item_unique_idx" ON "favorite_menu_item" USING btree ("userId", "menuItemId");

--
-- Class FavoriteRestaurant as table favorite_restaurant
--
...
-- Indexes
CREATE UNIQUE INDEX "favorite_restaurant_unique_idx" ON "favorite_restaurant" USING btree ("userId", "restaurantId");

--
-- Class LlmUsage as table llm_usage
--
...
--
-- Class MenuItem as table menu_item
--
...
--
-- Class MenuSourcePage as table menu_source_page
--
...
--
-- Class UserRestaurantVisit as table user_restaurant_visit
--
...
--
-- Foreign relations for "curated_dish_image" table
--
...
--
-- Foreign relations for "dish_catalog" table
--
...
--
-- Foreign relations for "dish_image" table
--
...
--
-- Foreign relations for "dish_provider_status" table
--
...
--
-- Foreign relations for "dish_translation" table
--
...
--
-- Foreign relations for "favorite_menu_item" table
--
ALTER TABLE ONLY "favorite_menu_item"
    ADD CONSTRAINT "favorite_menu_item_fk_0"
...
--
-- Foreign relations for "favorite_restaurant" table
--
...
--
-- Foreign relations for "menu_item" table
--
...
--
-- Foreign relations for "menu_source_page" table
--
...
--
-- Foreign relations for "user_restaurant_visit" table
--
