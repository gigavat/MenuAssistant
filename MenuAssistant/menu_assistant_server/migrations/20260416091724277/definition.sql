...
--
-- Class RestaurantMember as table restaurant_member
--
...
--
-- Foreign relations for "restaurant_member" table
--
ALTER TABLE ONLY "restaurant_member"
    ADD CONSTRAINT "restaurant_member_fk_0"
    FOREIGN KEY("restaurantId")
    REFERENCES "restaurant"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
